...
public class SecurityCookieServiceTest {
    ...
    public void createCookieFromClientAndExtractAuthentication() throws Exception {
        SecurityCookieService securityCookieService = new SecurityCookieService(new JwtClientSerializer(Base64.getEncoder().encodeToString(new byte[32]), new ObjectMapper(), new ExpirationJwtClaimsVerifier()));
