...
public class ApiLogInServiceIntegrationTest {
    ...
    public void testSuccessfulApiLogin() throws Exception {
        ...
        ApiLoginService apiLoginService = new ApiLoginService(new DefaultResourceLoader(), new ApiUserService(new ApiUser("success_user", "any_password", "1")), httpClient, "http://localhost:"+this.mockWebServer.getPort());
